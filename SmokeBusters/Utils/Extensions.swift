...
extension Color {
    ...
    static let BarBorder = Color("Tab Bar Border").opacity(0.5)
    static let CardBackground = Color("Forecast Card Background")
    static let Text = Color("Probability Text")
    static let directions = Color(hue: 0.752, saturation: 0.032, brightness: 1.0)
}
